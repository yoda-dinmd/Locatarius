...
| [UC-02 — Manage resident accounts](use-cases/UC-02.md) | Phase 1 creation (#63); the deferred phase access management | Association admin |
| [UC-03 — Own profile, password and association access](use-cases/UC-03.md) | Phase 1 password lifecycle for #62/#64; profile editing in the deferred phase | Authenticated user |
