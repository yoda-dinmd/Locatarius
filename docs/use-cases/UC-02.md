...
**Delivery:** Sprint 1 account creation (#63); the deferred post-internship phase listing and activation/deactivation.
...
1. Admin opens Add resident. In the deferred post-internship phase, the Users screen also includes a scoped list of accounts.
...
5. API returns 201 with safe DTO and Location; UI clears secrets, closes the form and announces success. In the deferred post-internship phase it also refreshes the list.
